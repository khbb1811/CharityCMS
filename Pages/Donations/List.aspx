                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <asp:DropDownList ID="ddlDonationType" runat="server"
                            ...
                            AutoPostBack="true"
                            OnSelectedIndexChanged="ddlDonationType_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
...
<div class="mb-3">
    ...
    <div class="form-text">يستخدم للتبرعات المالية فقط</div>
</div>
                    ...
                    <!-- محرر بنود التبرع العيني -->
                    <asp:Panel ID="pnlInKindEditor" runat="server" Visible="false" CssClass="border rounded p-3 mb-3 bg-light">
                        <h6 class="mb-3">بنود التبرع العيني</h6>

                        <asp:Literal ID="litInKindHelp" runat="server"></asp:Literal>

                        <div class="mb-3">
                            <label class="form-label">الصنف</label>
                            <asp:DropDownList ID="ddlInventoryItem" runat="server" CssClass="form-select"></asp:DropDownList>
                        </div>
                        ...
                        <div class="d-flex gap-2 mb-3">
                            <asp:Button ID="btnAddDonationItem" runat="server"
                                Text="إضافة بند"
                                CssClass="btn btn-success"
                                CausesValidation="false"
                                OnClick="btnAddDonationItem_Click" />
                        </div>

                        <asp:GridView ID="gvCurrentDonationItems" runat="server"
                            CssClass="table table-bordered table-sm"
                            AutoGenerateColumns="false"
                            EmptyDataText="لا توجد بنود مضافة بعد"
                            OnRowCommand="gvCurrentDonationItems_RowCommand">
                            <Columns>
                                <asp:BoundField DataField="DonationItemId" HeaderText="رقم" />
                                ...
                                <asp:TemplateField HeaderText="إجراء">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnDeleteItem" runat="server"
                                            Text="حذف البند"
                                            CssClass="btn btn-sm btn-danger"
                                            CommandName="DeleteDonationItem"
                                            CommandArgument='<%# Eval("DonationItemId") %>'
                                            CausesValidation="false"
                                            OnClientClick="return confirm('هل أنت متأكد من حذف هذا البند؟');">
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        ...
                        <div class="form-text mt-2">
                            بعد إضافة كل بند، سيتم تحديث كمية المخزون تلقائيًا.
                        </div>
                    </asp:Panel>
            ...
            <div class="card page-card">
                <div class="card-body">
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-md-3">
                            <label class="form-label">اسم المتبرع</label>
                            <asp:TextBox ID="txtSearchName" runat="server" CssClass="form-control" placeholder="ابحث بالاسم"></asp:TextBox>
                        </div>

                        <div class="col-md-3">
                            <label class="form-label">رقم الجوال</label>
                            <asp:TextBox ID="txtSearchPhone" runat="server" CssClass="form-control" placeholder="ابحث بالجوال"></asp:TextBox>
                        </div>
        ...
        OnClick="btnExportExcel_Click" />
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvDonations" runat="server"
                            ...
                            AllowPaging="true"
                            PageSize="10"
                            OnPageIndexChanging="gvDonations_PageIndexChanging"
                    ...
                    <!-- تفاصيل -->
                    <asp:Panel ID="pnlDetails" runat="server" Visible="false" CssClass="mt-4" ClientIDMode="Static">
